        ...
        <div className="md:mt-[130px] mt-[80px] w-full md:w-[1172px] mx-auto">
            ...
            <div className='md:flex items-center justify-between gap-[124px] mt-[40px]'>
                <div className='relative px-5'  >
                    ...
                    <div className='h-[200px] w-[200px] bg-gradient-to-b from-red-500 to-blue-900 shadow-lg rounded-full flex flex-col justify-center items-center absolute top-[170px] right-[20px] md:top-[110px] md:right-[-90px] text-white'>
                        <p>Start Now For</p>
                        <h4>FREE</h4>
                        <p>7 Day Trail</p>
                    </div>
