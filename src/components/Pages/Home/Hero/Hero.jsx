        ...
        <div className="md:flex justify-between gap-[41px] items-center mt-[46px] relative xl:w-[1280px] md:px-5 w-full mx-auto">
            <div className="md:w-1/2 w-full p-4 md:p-0 relative">
                ...
                <Reveals>
                    ...
                    <h1 className=" text-left text-[40px] md:text-[50px] xl:text-[82px] font-bold"><span className='text-[#FF3D4F]'>Special</span> People <br />
                        Around You</h1>
                </Reveals>
                <Reveals>
            ...
            <div className="md:w-1/2 px-5 md:px-0 relative ">

                <img className=' md:w-[564p] md:h-[406px] lg:w-[564px] lg:h-[606px] ' src={frameImage} alt="" />

                <div className='w-[156px] h-[48px] flex items-center gap-[13px] justify-center absolute right-0 lg:right-[35px] top-[60%] lg:top-[65%]' style={{ borderRadius: '40px',
                background: '#FFF',
