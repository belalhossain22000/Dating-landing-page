    ...
    return (
        <div  className="md:flex justify-between gap-[41px] items-center mt-[46px] relative xl:w-[1280px] md:px-5 w-full mx-auto">
            <div data-aos='fade-right' data-aos-delay="50" data-aos-duration='2000' className="md:w-1/2 w-full p-4 md:p-0 ">
                <h1 data-aos='fade-right' data-aos-delay="50" data-aos-duration='3000'  className="heading text-left "><span className='text-[#FF3D4F]'>Special</span> People <br />
                    Around You</h1>
                ...
                <div data-aos='fade-right' data-aos-delay="50" data-aos-duration='5000'  className="md:flex items-center md:gap-[38px]  md:w-[426px] md:h-[80px] p-5 md:p-0 space-y-5 md:space-y-0  md:ml-0 mt-[40px] md:rounded-l-[20px] rounded-md" style={{boxShadow:' 0px 30px 250px 0px rgba(51, 51, 51, 0.20)'}}>
            ...
            <div data-aos='fade-left' data-aos-delay="50" data-aos-duration='2000'  className="md:w-1/2 px-5 md:px-0 ">
                ...
                <div data-aos='fade-left' data-aos-delay="50" data-aos-duration='1000'  className='absolute right-[0%] md:-bottom-11 xl:bottom-4 xl:right-[4%] bottom-4 bg-[#fff] pl-12 pt-5 md:px-[11px] md:py-[10px]' style={{
                    borderRadius: '60px',
                    background: '#FFF',
