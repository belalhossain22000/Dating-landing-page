        ...
        <div className="md:mt-[130px] mt-[80px] w-full max-w-[1280px] mx-auto bg-red-70">
            ...
            <Reveals>
                <div className="flex justify-center items-center gap-[38px]   rounded-[30px] border-[1px] w-[212px] mx-auto h-[60px] mt-[40px] py-[5px] px-[7px]">
                    ...
                    }} onClick={() => setActive(!active)} className={` ${!active ? "bg-[#FF3D4F] py-[11px] px-[22px] rounded-[30px] text-white hover:bg-white  hover:text-[#FF6E7B] hover:border-[1px] hover:border-[#FF6E7B]  " : 'text-[#FF6E7B]'} `} >Monthly</motion.button>
                    <motion.button whileHover={{
                        scale: 1.1,
                        textShadow: '0px 0px 8px #ED3E3E',
                        boxShadow: '0px 00px 8px #ED3E3E ',
                    }} onClick={() => setActive(!active)} className={` ${active ? " bg-[#FF3D4F] py-[11px] px-[22px] rounded-[30px] text-white hover:bg-white  hover:text-[#FF6E7B] hover:border-[1px] hover:border-[#FF6E7B] " : 'text-[#FF6E7B]'}   `}>Yearly</motion.button>
                </div>
            </Reveals>
            {/* card */}
            {/* monthly */}
            {!active && <div className='md:flex items-center justify-center space-y-5 md:ml-10 lg:ml-0 gap-5 lg:gap-[100px] xl:gap-[322px]'>
                ...
                <div className='mt-[40px] flex flex-col-reverse md:flex-row  lg:gap-[56px] '>
                    <motion.div whileHover={{
                        ...
                        textShadow: '0px 0px 8px #ED3E3E',
                        boxShadow: '0px 00px 8px #ED3E3E ',
                    }} data-aos='flip-down' className='h-[400px] w-[275px] mx-auto md:mx-0 bg-[#FFF] rounded-[50px] px-[23px] py-[61px] ' style={{ boxShadow: "0px 30px 60px 0px rgba(238, 68, 68, 0.15)" }}>
                        <Reveals>
                        ...
                        <Reveals>
                            <motion.button whileHover={{
                                ...
                                textShadow: '0px 0px 8px #ED3E3E',
                                boxShadow: '0px 00px 8px #ED3E3E ',
                            }} className=' hover:bg-white  hover:text-[#FF6E7B] hover:border-[1px] hover:border-[#FF6E7B]  bg-[#FF3D4F] text-white px-[32px] py-[20px] rounded-[30px] mt-[20px]'>
                                Suscrib Now
                            </motion.button>
                        </Reveals>
            ...
            {active && <div className='md:flex items-center justify-center space-y-5 md:ml-10 lg:ml-0 gap-5 lg:gap-[100px] xl:gap-[322px]'>
                ...
                <div className='mt-[40px] flex flex-col-reverse md:flex-row lg:gap-[56px]'>
                    <motion.div whileHover={{
                        ...
                        textShadow: '0px 0px 8px #ED3E3E',
                        boxShadow: '0px 00px 8px #ED3E3E ',
                    }} data-aos='flip-down' data-aos-delay="50" data-aos-duration='2000' className='h-[400px] w-[275px] mx-auto md:mx-0 bg-[#FFF] rounded-[50px] px-[23px] py-[61px] ' style={{ boxShadow: "0px 30px 60px 0px rgba(238, 68, 68, 0.15)" }}>
                        <Reveals>
                            <h3 className='text-[#33357D] text-2xl font-semibold mb-[10px]'>Premium </h3>
                        </Reveals>
                        <Reveals>
                    ...
                    <div className='flex justify-center md:justify-start my-5 md:my-0'>
                        <div data-aos='fade-down' data-aos-delay="50" data-aos-duration='2000' className='relative h-[110px] w-[110px]'>
                            <img src={star} alt="" className='h-[110px] w-[110px]' />
                            <div className='text-white absolute top-7 left-8 h-[110px] w-[110px]'>
                                <h1 className='text-2xl font-bold'>$70</h1>
