...
const SuccessStory = () => {
    return (
        <div className="md:mt-[148px] mt-[50px] w-full max-w-[1280px] mx-auto md:flex items-center justify-between lg:gap-[210px] ">
            <div className="1/2 px-10 md:text-left text-center">
            ...
            <div className='flex justify-center'>
                <div className="1/2 relative px-5 mt-24 w-[468px] ml-0">
                    ...
                    {/* mini circle images */}
                    <div className='absolute md:top-[173px]  md:right-[150px] top-[130px] right-[37%]'>
                    ...
                    <div className='absolute top-[30%] md:top-[100px] right-[-3%] md:right-[-18px]'>
                        <div className='relative flex justify-center items-center h-[98px] w-[98px]'>
                            <img src={image3} alt="" />
                    ...
                    <div className='md:right-[30px] right-[5%] bottom-5 md:bottom-8 absolute'>
                        <div className='relative flex justify-center items-center h-[98px] w-[98px]'>
                            <img src={image6} alt="" />
